...
const clientEntrypoints = [
  {
    name: 'CLIENT - Dialog',
    entry: './src/client/dialog/index.tsx',
    filename: 'dialog',
    ...
    switch (packageName) {
      ...
      case 'lodash':
        return {
          ...
          var: '_',
          version: packageVersion,
          // url: `https://unpkg.com/lodash@${packageVersion}/lodash${packageSuffix}`,
          url: `https://cdn.jsdelivr.net/npm/lodash@${packageVersion}/lodash${packageSuffix}`,
        };
      case '@types/lodash':
        return {
          name: packageName,
          var: '@types/lodash',
          version: packageVersion,
          url: `https://unpkg.com/@types/lodash@${packageVersion}/index.d.ts`,
        };
      case '@mui/lab':
        return {
          name: packageName,
          var: 'muilab',
          version: packageVersion,
          url: `https://cdn.jsdelivr.net/npm/@mui/lab@${packageVersion}/index.js`,
        };
      case '@reduxjs/toolkit':
        return {
          ...
          var: 'reduxjstoolkit',
          version: packageVersion,
          url: `https://cdn.jsdelivr.net/npm/@reduxjs/toolkit@${packageVersion}/dist/redux-toolkit.umd.min.js`,
        };
      case 'react-redux':
        return {
          name: packageName,
          var: 'reactRedux',
          version: packageVersion,
          url: `https://cdn.jsdelivr.net/npm/react-redux@${packageVersion}/dist/react-redux.min.js`,
        };
      case 'react-phone-input-2':
        return {
          ...
          var: options.var,
          version: packageVersion,
          url: `https://unpkg.com/react-phone-input-2@${packageVersion}/lib/lib.js`,
        };
